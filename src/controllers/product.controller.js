...
exports.addRecord = async(req, res) => {
    ...
    console.log('INSERT INTO "tblRecord"(contributor, content, locations, lat, lng) VALUES ($1, $2, $3, $4)',
        [contributor, content, locations, lat, lng]);
    let {recordRows} = await db.query(
        'INSERT INTO "tblRecord"(contributor, content, locations, lat, lng) VALUES ($1, $2, $3, $4)',
        [contributor, content, locations, lat, lng]
    )
